  ...
  return (
    <motion.div variants={fadeUp} initial="initial" animate="animate"
      ...
      <div className="flex flex-col gap-3">
        {loading ? (
          <div className="text-center py-8 text-xs text-gray-500">Loading recent candidates...</div>
        ) : candidates.length === 0 ? (
          <div className="text-center py-8 text-xs text-gray-500">No candidates analyzed yet.</div>
        ) : (
          candidates.map((c, i) => {
