  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute bottom-16 right-0 w-80 bg-black/70 backdrop-blur-md border border-purple-500/30 rounded-2xl p-4 mb-2"
          >
      ...
      <motion.button
        ...
        className="w-12 h-12 rounded-full bg-gradient-to-br from-purple-600 to-purple-800 text-white shadow-lg hover:shadow-purple-500/50 flex items-center justify-center text-xl font-bold border border-purple-400/30"
      >
        🧠
      </motion.button>
    </div>
