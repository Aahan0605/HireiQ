            ...
            <MagneticCard className="p-8 border-black/10 dark:border-white/10 bg-[#13131f]">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4 border-b border-white/5 pb-4">
                <div>
                  ...
                  <span className="inline-flex items-center gap-1 rounded-full bg-amber-500/10 border border-amber-500/20 px-2.5 py-0.5 mt-1 text-[10px] font-semibold text-amber-400 uppercase tracking-wide">
                    AI Interview Simulator (Demo Mode — scripted responses)
                  </span>
                </div>
